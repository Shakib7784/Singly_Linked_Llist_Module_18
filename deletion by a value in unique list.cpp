...
void deletionAtTail(Node *&head)
{
    ...
    else
    {
        ...
        {
           // delete temp;
           // or we can call delete from head function because here, head and tail is same basically
             deletionAtHead(head);
...
void delete_from_specific_position(Node *&head, int pos)
{
    ...
    else
    {
        ...
        else if( pos<= length(head))
        {
            ...
            delete delnode;
             cout<<"Deletion successfully completed"<<endl;
             cout<<"Linked list after deletion"<<endl;
            display(head);
        }
        else
...
void deletion_by_value_InUniqueList(Node *&head, int val)
{
    Node *temp= head;
    if(temp==NULL)
    {
...
int main()
{
    ...
    cout<<"Choice 4: Searching value from unique valued linked list"<<endl;
    ...
    cout<<"Choice 10: Delete by value in unique list "<<endl;
    ...
    while(choice!=0)
    {
       ...
       {
           cout<<"Enter value that you want to delete: f";
           cin>>value;
           deletion_by_value_InUniqueList(head,value);
       }
        else
        {
            break;
